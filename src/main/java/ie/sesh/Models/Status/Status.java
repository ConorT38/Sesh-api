...
public class Status {
    ...
    public Status(int id, int user_id, String name, String username, String message, int location, int likes, boolean liked, Timestamp date, String going,String maybe, String not_going) {
        this.id = id;
