...
public class Status {
    ...
    public Status(int user_id, String name, String username, String profile_pic, String message, int location, int likes, boolean liked, Timestamp date, String going,String maybe, String not_going) {
        this.user_id = user_id;
        this.name = name;
        this.username = username;
        this.profile_pic = profile_pic;
