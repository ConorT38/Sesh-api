...
public class SQLConstants {
    ...
    public static final String HIDE_NOTIFICATION = "UPDATE notifications SET hidden = ? WHERE id = ?;";
    public static final String READ_NOTIFICATION = "UPDATE notifications SET read = ? WHERE id = ?;";
}
